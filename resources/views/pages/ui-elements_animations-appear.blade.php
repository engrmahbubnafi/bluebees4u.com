...
<div class="animated fadeInUp">
    ...
    <div class="row mt-xl">
        <div class="col-sm-2">
            <img alt="animation image" id="img-1" class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
        <div class="col-sm-10">
    ...
    <div class="row mt-xl">
        <div class="col-sm-2 col-sm-push-10">
            <img alt="animation image" id="img-2" class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
    ...
    <div class="row mt-xl">
        <div class="col-sm-2">
            <img alt="animation image" id="img-3" class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
        <div class="col-sm-5">
    ...
    <div class="row mt-xl">
        <div class="col-sm-2 col-sm-push-10">
            <img alt="animation image" id="img-4" class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
        <div class="col-sm-5 col-sm-pull-2">
    ...
    <div class="row mt-xl">
        <div class="col-sm-2">
            <img alt="animation image" id="img-5" class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
        <div class="col-sm-5">
    ...
    <div class="row mt-xl">
        <div class="col-sm-2 col-sm-push-10">
            <img alt="animation image" id="img-6" class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
        <div class="col-sm-5 col-sm-pull-2">
    ...
    <div class="row mt-xl">
        <div class="col-sm-2">
            <img alt="animation image" id="img-7" class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
        <div class="col-sm-4">
    ...
    <div class="row mt-xl">
        <div class="col-sm-2">
            ...
            <img data-animation-name="wobble" alt="animation image"  class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
        <div class="col-sm-2">
            <h5 class="highlight text-center">bounce</h5>
            <img data-animation-name="bounce" alt="animation image"  class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
        <div class="col-sm-2">
            <h5 class="highlight text-center">flash</h5>
            <img data-animation-name="flash" alt="animation image"  class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
        <div class="col-sm-2">
            <h5 class="highlight text-center">pulse</h5>
            <img data-animation-name="pulse" alt="animation image"  class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
        <div class="col-sm-2">
            <h5 class="highlight text-center">shake</h5>
            <img data-animation-name="shake" alt="animation image"  class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
        <div class="col-sm-2">
            <h5 class="highlight text-center">tada</h5>
            <img data-animation-name="tada" alt="animation image"  class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
    </div>
    <div class="row mt-xl">
        <div class="col-sm-2">
            <h5 class="highlight text-center">bouceIn</h5>
            <img data-animation-name="bouceIn" alt="animation image"  class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
        <div class="col-sm-2">
            <h5 class="highlight text-center">bounceInLeft</h5>
            <img data-animation-name="bounceInLeft" alt="animation image"  class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
        <div class="col-sm-2">
            <h5 class="highlight text-center">bounceInRight</h5>
            <img data-animation-name="bounceInRight" alt="animation image"  class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
        <div class="col-sm-2">
            <h5 class="highlight text-center">bounceInDown</h5>
            <img data-animation-name="bounceInDown" alt="animation image"  class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
        <div class="col-sm-2">
            <h5 class="highlight text-center">bounceInUp</h5>
            <img data-animation-name="bounceInUp" alt="animation image"  class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
        <div class="col-sm-2">
            <h5 class="highlight text-center">bounceInRight</h5>
            <img data-animation-name="bounceInRight" alt="animation image"  class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
    ...
    <div class="row mt-xl">
        ...
        <div class="col-sm-2">
            ...
            <img data-animation-name="fadeInLeft" alt="animation image"  class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
        <div class="col-sm-2">
            <h5 class="highlight text-center">fadeInRight</h5>
            <img data-animation-name="fadeInRight" alt="animation image"  class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
        <div class="col-sm-2">
            <h5 class="highlight text-center">fadeInDown</h5>
            <img data-animation-name="fadeInDown" alt="animation image"  class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
        <div class="col-sm-2">
            <h5 class="highlight text-center">fadeInUp</h5>
            <img data-animation-name="fadeInUp" alt="animation image"  class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
        </div>
        <div class="col-sm-2">
            <h5 class="highlight text-center">fadeInRight</h5>
            <img data-animation-name="fadeInRight" alt="animation image"  class="img-animated" src="{{ asset('images/helsinki.jpg') }}" />
