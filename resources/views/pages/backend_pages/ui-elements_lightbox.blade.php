            ...
            <div class="panel-content">
                ...
                <div class="row">
                    <div class="col-xs-6 col-md-3">
                        <a href="{{ asset('images/helsinki-lg.jpg') }}" title="By John Doe" class="image">
                            <img alt="first photo" src="{{ asset('images/helsinki.jpg') }}" class="img-responsive mb-sm">
                        </a>
                    </div>
                    <div class="col-xs-6 col-md-3">
                        <a href="{{ asset('images/helsinki-lg.jpg') }}" title="By John Doe" class="image">
                            <img alt="second photo" src="{{ asset('images/helsinki.jpg') }}" class="img-responsive mb-sm">
                        </a>
                    </div>
                    <div class="col-xs-6 col-md-3">
                        <a href="{{ asset('images/helsinki-lg.jpg') }}" title="By John Doe" class="image">
                            <img alt="third photo" src="{{ asset('images/helsinki.jpg') }}" class="img-responsive mb-sm">
                        </a>
                    </div>
                    <div class="col-xs-6 col-md-3">
                        <a href="{{ asset('images/helsinki-lg.jpg') }}" title="By John Doe" class="image">
                            <img alt="fourth photo" src="{{ asset('images/helsinki.jpg') }}" class="img-responsive mb-sm">
                        </a>
                    </div>
                </div>
            </div>
