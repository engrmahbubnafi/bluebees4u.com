...
@section('content')
    <div class="content-header">
        ...
        <div class="leftside-content-header">
            <ul class="breadcrumbs">
                ...
                <li><a>Enter Products details and submit</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="row animated fadeInRight">
        <div class="col-sm-12">
            <h4 class="section-subtitle"><b>New Products</b></h4>
        ...
        btn-elevate btn-icon-sm'))) !!}
            ...
            <div class="panel">
                <!--begin::Form-->
                {{ Form::model(request()->old(),array('route' => array('products.store'),'class'=>'form-horizontal','novalidate'=>'novalidate')) }}
