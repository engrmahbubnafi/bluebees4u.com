    ...
    <div class="content-header">
        ...
        <div class="leftside-content-header">
            <ul class="breadcrumbs">
                <li><i class="fa fa-columns" aria-hidden="true"></i><a href="{{ Request::url() }}">New Promotion
                        Code</a></li>
            </ul>
        </div>
    </div>
    <div class="col-xs-6 col-sm-6 col-md-12 col-lg-12 col-xl-12">
        <h4 class="section-subtitle">Add New Promotion Code</h4>
        <div class="panel">
            <div class="panel-content">
                <div class="row">
                    <div class="col-xs-6 col-sm-6 col-md-12 col-lg-12 col-xl-12">
                        {{ Form::model(request()->old(),array('route' => array('promotion.store'),'class'=>'form-horizontal','novalidate'=>'novalidate')) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3">
                                {{Form::checkbox('is_percentage','1',true,array('required' =>'required','id'=>'is_percentage')) }}
                                @error('is_percentage')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
