...
<div class="content-header">
    ...
    <div class="leftside-content-header">
        <ul class="breadcrumbs">
            <li><i class="fa fa-table" aria-hidden="true"></i><a href="">Queen Bee Subscribers</a></li>
...
<div class="row animated fadeInRight">
    <div class="col-sm-12">
        <h4 class="section-subtitle"><b>Queen Bee Subscribers</b></h4>
        <div class="panel">
            <div class="panel-content">
                <div class="table-responsive">
                    <table id="users_table"
                        ...
                        <tbody>
                            @foreach ($queenBeeSubscribers as
                            $queenBeeSubscriber)
                            <tr>
                                <td>{{ $queenBeeSubscriber->customer_id }}</td>
                                <td>{{ $queenBeeSubscriber->first_name }}
                                    {{ $queenBeeSubscriber->last_name }} <br>
                                    {{ $queenBeeSubscriber->phone }} <br>
                                    {{ $queenBeeSubscriber->email }}
                                </td>
                                <td>{{ $queenBeeSubscriber->facebook_link }}
                                </td>
                                <td>{{ $queenBeeSubscriber->product_category }}
                                </td>
                                <td>
                                    @php
                                    // create a $dt object with the UTC timezone
                                    $dt = new
                                    DateTime($queenBeeSubscriber->updated_at,
