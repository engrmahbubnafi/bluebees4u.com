...
<div class="content-header">
    ...
    <div class="leftside-content-header">
        <ul class="breadcrumbs">
            <li><i class="fa fa-table" aria-hidden="true"></i><a href="">Bumble Bee Subscribers</a></li>
...
<div class="row animated fadeInRight">
    <div class="col-sm-12">
        <h4 class="section-subtitle"><b>Bumble Bee Subscribers</b></h4>
        <div class="panel">
            <div class="panel-content">
                <div class="table-responsive">
                    <table id="users_table"
                        ...
                        <tbody>
                            @foreach ($bumbleBeeSubscribers as
                            $bumbleBeeSubscriber)
                            <tr>
                                <td>{{ $bumbleBeeSubscriber->customer_id }}</td>
                                <td>{{ $bumbleBeeSubscriber->first_name }}
                                    {{ $bumbleBeeSubscriber->last_name }} <br>
                                    {{ $bumbleBeeSubscriber->phone }} <br>
                                    {{ $bumbleBeeSubscriber->email }}
                                </td>
                                <td>{{ $bumbleBeeSubscriber->facebook_link }}
                                </td>
                                <td>{{ $bumbleBeeSubscriber->product_category }}
                                </td>
                                <td>
                                    @php
                                    // create a $dt object with the UTC timezone
                                    $dt = new
                                    DateTime($bumbleBeeSubscriber->updated_at,
