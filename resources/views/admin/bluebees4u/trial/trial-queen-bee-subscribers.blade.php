    ...
    <div class="leftside-content-header">
        <ul class="breadcrumbs">
            <li><i class="fa fa-table" aria-hidden="true"></i>
                <a href="">
                    Free Trial Queen Bee Subscribers
                </a>
            </li>
...
<div class="row animated fadeInRight">
    <div class="col-sm-12">
        <h4 class="section-subtitle"><b>Free Trial Queen Bee Subscribers</b>
        </h4>
        <div class="panel">
            <div class="panel-content">
                <div class="table-responsive">
                    <table id="users_table"
                        ...
                        <tbody>
                            @foreach ($trialQueenBeeSubscribers as $trialQueenBeeSubscribers)
                            <tr>
                                <td class="text-center">
                                    {{ $trialQueenBeeSubscribers->customer_id }}
                                </td>
                                <td class="text-center">
                                    {{ $trialQueenBeeSubscribers->first_name }} {{ $trialQueenBeeSubscribers->last_name }} <br>
                                    {{ $trialQueenBeeSubscribers->phone }} <br>
                                    {{ $trialQueenBeeSubscribers->email }}
                                </td>
                                <td class="text-center">
                                    {{ $trialQueenBeeSubscribers->facebook_link }}
                                </td>
                                <td class="text-center">
                                    {{ $trialQueenBeeSubscribers->product_category }}
                                </td>
                                <td class="text-center">
                                    @php
                                    // create a $dt object with the UTC timezone
                                    $dt = new
                                    DateTime($trialQueenBeeSubscribers->updated_at,
