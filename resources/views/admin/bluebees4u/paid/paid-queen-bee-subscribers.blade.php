...
<div class="row animated fadeInRight">
    <div class="col-sm-12">
        <h4 class="section-subtitle"><b>Paid Queen Bee Subscribers</b></h4>
        <div class="panel">
            <div class="panel-content">
                <div class="table-responsive">
                    <table id="users_table"
                        ...
                        <tbody>
                            @foreach ($paidQueenBeeSubscribers as $paidQueenBeeSubscriber)
                            <tr>
                                ...
                                <td class="text-center">
                                    {{ $paidQueenBeeSubscriber->facebook_link }}
                                </td>
                                <td class="text-center">
                                    {{ $paidQueenBeeSubscriber->product_category }}
                                </td>
                                <td class="text-center">
                                    @php
                                    // create a $dt object with the UTC timezone
                                    $dt = new
                                    DateTime($paidQueenBeeSubscriber->updated_at,
