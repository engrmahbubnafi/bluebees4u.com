    ...
    <div class="row animated fadeInRight">
        ...
        btn-elevate btn-icon-sm'))) !!}
            ...
            <div class="panel">
                ...
                <!--begin::Form-->
                {{ Form::model(request()->old(),array('route' => array('web_content.store'),'class'=>'form-horizontal','novalidate'=>'novalidate')) }}
                    ...
                    <div class="kt-section__body">
                        ...
                        <div class="kt-wizard-v4__form">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-3">
                                    {{Form::text('meta_key',' ',array('class' => (($errors->has("meta_key")) ? "form-control is-invalid" : "form-control"), 'required' =>'required'))}}
                                    @error('meta_key')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
