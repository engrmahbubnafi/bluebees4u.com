    ...
    <div class="content-header">
        ...
        <div class="leftside-content-header">
            <ul class="breadcrumbs">
                <li><i class="fa fa-columns" aria-hidden="true"></i><a href="{{ Request::url() }}">New Package</a></li>
            </ul>
        </div>
    </div>
    <div class="col-xs-6 col-sm-6 col-md-12 col-lg-12 col-xl-12">
        <h4 class="section-subtitle">Add New Package</h4>
        <div class="panel">
            <div class="panel-content">
                <div class="row">
                    <div class="col-xs-6 col-sm-6 col-md-12 col-lg-12 col-xl-12">
                        {{ Form::model(request()->old(),array('route' => array('package.store'),'class'=>'form-horizontal','novalidate'=>'novalidate')) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3">
                                {{Form::checkbox('is_signup_able','1',true,array('required' =>'required','id'=>'is_signup_able')) }}
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 col-form-label require">Package Features</label>
                            <div class="col-lg-3">
                            ...
                            <div class="col-md-7">
                                <i class="fa fa-plus-circle plus_icon_row_number"
                                   id="add_package_feature"
                                   style="font-size:26px;color:green; cursor: pointer; float: left;"
                                   aria-hidden="true"></i>
                            </div>
                        </div>
