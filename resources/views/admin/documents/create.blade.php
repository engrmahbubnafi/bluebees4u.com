...
@section('content')
    ...
    <div class="row animated fadeInRight">
        <div class="col-sm-12">
            <h4 class="section-subtitle"><b>New Documents</b></h4>
        ...
        btn-elevate btn-icon-sm'))) !!}
            ...
            <div class="panel">
                ...
                <!--begin::Form-->
                {{ Form::model(request()->old(),array('route' => array('documents.store'),'class'=>'form-horizontal','novalidate'=>'novalidate','enctype'=>"multipart/form-data")) }}
                    ...
                    <div class="kt-section__body">
                        ...
                        <div class="kt-wizard-v4__form">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    {{Form::text('name','&nbsp;',array('class' => (($errors->has("name")) ? "form-control is-invalid" : "form-control"), 'required' =>'required'))}}
                                    @error('name')
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-lg-2 col-form-label require">Documents</label>
                                <div class="col-lg-3">
                                    {{Form::file('file',array('class' => (($errors->has("file")) ? "form-control is-invalid" : "form-control"), 'required' =>'required','accept'=>"*",'id'=>'attach_file'))}}
                                    {{Form::text('file',null,array('class' => (($errors->has("name")) ? "form-control is-invalid" : "form-control"), 'required' =>'required', 'id' =>'file_text','style'=>'display:none'))}}
                                    @error('file')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-3">
                                    {{Form::checkbox('is_downloadable','1',true,array('required' =>'required','id'=>'is_downloadable')) }}
...
@push('script')
    ...
    <script>
        ...
        function getMessage() {
            $.ajax({
                type: 'GET',
                url: '/get-document_mime/' + $("#type_id").val(),
