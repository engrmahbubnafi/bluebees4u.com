...
@section('title', 'Edit Documents Type')
@section('content')
        ...
        btn-elevate btn-icon-sm'))) !!}
            ...
            <div class="panel">
                <div class="panel-content">
                    {{ Form::model($documents_type,array('route' => array('document_type.update', $documents_type->id),'class'=>'kt-form form-horizontal','novalidate'=>'novalidate','method' => 'PUT')) }}
                    <div class="panel-content">
                        <div class="kt-section__body">
                            ...
                            <div class="kt-wizard-v4__form">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-3">
                                        {{Form::text('mime_type',null,array('class' => (($errors->has("mime_type")) ? "form-control is-invalid" : "form-control"), 'required' =>'required'))}}
                                        @error('mime_type')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
