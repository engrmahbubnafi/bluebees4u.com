...
@section('content')
    ...
    <div class="row animated fadeInRight">
        <div class="col-sm-12">
            <h4 class="section-subtitle"><b>Documents Type Lists</b></h4>
            <span class="pull-right">
                {!! Html::decode(link_to_route('document_type.create','<i class="fa fa-plus"></i> New Documents Type',null,array('class'=>'btn btn-success','style'=>'margin-bottom:10px'))) !!}
        </span>
            <div class="panel">
                <div class="panel-content">
                    <div class="table-responsive">
                        <table id="basic-table" class="data-table table table-striped nowrap table-hover"
                            ...
                            <tbody>
                            @foreach ($documents_type as $data)
                                <tr>
                                    <td>{{$data->name}}</td>
                                    <td>{{$data->slug}}</td>
                                    ...
                                    <td class="text-center">
                                        {!!  Html::decode(link_to_route('document_type.edit', '<span aria-hidden="true" class="fa fa-pencil" data-tooltip="Edit"></span>', array($data->id)))!!}
