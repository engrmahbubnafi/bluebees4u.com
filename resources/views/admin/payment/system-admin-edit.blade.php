    ...
    <div class="content-header">
        <div class="leftside-content-header">
            <ul class="breadcrumbs">
                <li><i class="fa fa-columns" aria-hidden="true"></i><a href="{{ Request::url() }}">System Admin Edit</a></li>
            </ul>
        </div>
    </div>

    <div class="col-xs-6 col-sm-6 col-md-12 col-lg-12 col-xl-12">
        <h4 class="section-subtitle">System Admin Edit</h4>
        <div class="panel">
            <div class="panel-content">
                <div class="row">
                    <div class="col-xs-6 col-sm-6 col-md-12 col-lg-12 col-xl-12">
                        {{ Form::model($payment, [
                            'route' => ['payments.system_admin_edit.update', $payment->id],
                            ...
                            <div class="kt-section__body">
                                ...
                                <div class="kt-wizard-v4__form">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            {{ Form::select('customer_id', $customer, $payment->customer_id, ['class' => 'form-control', 'required' => 'required', 'multiple' => false, 'id' => 'customer_id']) }}
                                            @error('customer_id')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            {{ Form::text('account_number', $payment->account_number, ['class' => $errors->has('account_number') ? 'form-control is-invalid' : 'form-control', 'id' => 'account_number']) }}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            {{ Form::text('transaction_id', $payment->transaction_id, ['class' => $errors->has('transaction_id') ? 'form-control is-invalid' : 'form-control', 'id' => 'transaction_id']) }}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            {{ Form::select('payment_package', $package, $payment->payment_package, ['class' => 'form-control', 'required' => 'required', 'multiple' => false, 'id' => 'payment_package']) }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row" style="padding-bottom: 5px">
                                            <div class="col-sm-2"></div>
                                            <div class="col-sm-4">
                                                {{ Form::text('additional_amount', $payment->additional_amount, ['class' => 'form-control', 'id' => 'additional_amount']) }}
                                            ...
                                            <div class="col-sm-4">
                                                {{ Form::text('additional_amount_note', $payment->additional_amount_note, ['class' => 'form-control', 'id' => 'additional_amount_note']) }}
                                        ...
                                        <div data-repeater-list="third_party">
                                            @php
                                                ...
                                                if (old('third_party') && count(old('third_party'))) {
                                                    $third_parties = old('third_party');
                                                } elseif ($payment->ThirdParties->count()) {
                                                    $third_parties = $payment->ThirdParties->toArray();
                                                }
                                            @endphp
                                            @if (count($third_parties))
                                                @foreach ($third_parties as $key => $item)
